...
- <span style="color: #8a2be2;"><b>PB = 5</b></span>
- Tracker: [ ] [ ] [ ] [ ] [ ]

#### Fungal Infestation (Circle of Spores)
- Uses: **4 per long rest**
- Tracker: [ ] [ ] [ ] [ ]
...
- <span style="color: #8a2be2;"><b>Concentration check</b></span>: `d20 + CON save mod` (see dice macro: **Concentration (CON)**)

---

## 📌 How to Use This Sheet

Each spell/feature section has:
- **Source citation** (book + year + page). If the page is unknown, it’s marked with ❓ so you can verify later.
- **Official text** (paste here)
- **Ribbitz Notes / Math** in purple
- **Dice macros** (if you have a Sophie’s Dice button)

### Citation format (copy/paste)

**Source:** *Book Name* (Year) — p. ___ ❓
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>Spellcasting mod (WIS) = +4</b></span>
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>Heals = 1d8 + WIS mod (4)</b></span> at 1st level
- <span style="color: #8a2be2;"><b>2nd level = 2d8 + 4</b></span>
- <span style="color: #8a2be2;"><b>3rd level = 3d8 + 4</b></span>
- Dice macros you have: **Cure Wounds 1**, **Cure Wounds 2** (confirm upcast behavior)
...
### Ribbitz Notes / Math
- Ritual option: no slot spent if cast as ritual (adds 10 min to casting time)
- Duration: **10 minutes**

---

## Wild Cunning (UA) (Ritual)
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>At 2nd level = 20 gallons or 35-foot cube</b></span>
...
## Hunter’s Mark (Concentration) (Fey Touched)
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>Heals 1d6 per use</b></span> at 2nd level
- <span style="color: #8a2be2;"><b>Number of heals = 5</b></span> (1 + WIS mod 4)
- <span style="color: #8a2be2;"><b>3rd level = 2d6 per use</b></span>
- Dice macro: **Spell Healing Spirit Heal** (currently `1d6`, adjust for table/errata later)
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>Save DC = 17</b></span>
- <span style="color: #8a2be2;"><b>Damage at 2nd level = 2d10 radiant</b></span> (half on success)
- <span style="color: #8a2be2;"><b>Damage at 3rd level = 3d10 radiant</b></span>
- Dice macros:
  - **Spell Moonbeam L2 Fail** / **Spell Moonbeam L2 Succ (Half)**
  - **Spell Moonbeam L3 Fail** / **Spell Moonbeam L3 Succ (Half)**
...
- Affects creatures within **30 feet** of you
- Duration: **Concentration, up to 1 hour**
- Dice macro: **Spell Pass Trace (+10)**
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>Save DC = 17</b></span>
- Duration: **1 minute** (target can repeat save each turn)
- <span style="color: #8a2be2;"><b>At 3rd level = 2 creatures</b></span>
...
### Ribbitz Notes / Math
- <span style="color: #8a2be2;"><b>Save DC = 17</b></span>
- <span style="color: #8a2be2;"><b>Damage at Druid Level 9 = 1d6</b></span> necrotic (6th level threshold reached)
- <span style="color: #8a2be2;"><b>With Symbiotic Entity active = 2d6</b></span> (roll damage die twice)
- Dice macros:
  - **Spell Halo of Spores Dmg** (`1d6`)
  - **Spell Halo Spores Sym Dmg** (`2d6`) when Symbiotic Entity is active
...
- While active: Halo damage die is rolled **twice**; melee attacks gain **+1d6 necrotic**
