...
> Tip: Use GitHub’s page search (`Ctrl+F`) + these headings to jump fast.

- [🛡️ Quick Stats](#️-quick-stats)
- [🐸 Racial / Homebrew Traits](#-racial--homebrew-traits)
- [📊 Ability Scores & Skills](#-ability-scores--skills)
- [⚔️ Combat](#️-combat---actions)
...
<details>
<summary><h2>PreCampaign Ribbitz Backstory (click to expand)</h2></summary>
...
* **Jumping (Hopping):**
  ...
  - **Standing Jump:** = **(d20 + (STR or DEX) + Proficiency) / 2** (Result = movement in feet).
  - *Note:* Jump can be in any direction.
...
### Attacks
* **Vanguard Double-Barrel Blowgun (+1 Fey Inverted Water Fall Blessing):**
  - **Standard Hit (per barrel shot):** +13 (DEX +5, PB +5, Archery +2, +1 Magic)
...
* **Song of the Grung (1/Day):** While wielding blowgun, croak into it. 30ft line. 2d8 Thunder damage + 10ft push. CON Save 17 for half/no push. (Based on Spell Save DC). Deafens within 15ft.
* **Double-Barrel (Bonus Action):** Shoot at multiple (2) enemies.
* **Hot-Swap (Bonus Action):** Swap damage types.
* **Poison Darts (Usage Limits):**
  - **Sleep:** 1/day. CON Save 17 (Unconscious 1 min).
  - **Paralyze:** 1/day. CON Save 17 (Paralyzed 1 min).
  - **Purple Grung:** 5/day. CON Save 17 (Seek water 1 min).
...
*Note: Level 12 Caster (Druid 9 + [Ranger 6/2]). Shares combined slots for all spells.*
...
* **Absorb Elements** (Druid | XGtE 150)
* **Faerie Fire** (Druid | PHB 239 | Conc)
* **Goodberry** (Druid | PHB 246)
* **Create or Destroy Water** (Ranger | PHB 229)
* **Detect Magic** (Ranger | PHB 231 | Ritual)
* **Jump** (Ranger | PHB 254)
...
* **Lesser Restoration** (Druid | PHB 255)
* **Pass Without Trace** (Ranger | PHB 264 | Conc)
* **Rope Trick** (Ranger | PHB 272)
* **Misty Step** (Feat | PHB 260)
...
<details>
<summary><h3>📘 Spell Notes / Reminders (click to expand)</h3></summary>

- **Spellcasting:** Wisdom-based.
- **Multiclass slots:** Use the combined caster table (already reflected above).
- **Commonly used in play:** *Pass Without Trace*, *Absorb Elements*, *Moonbeam*, *Healing Spirit*.
...
> This section is long. Use the collapsible headers to keep it readable.
